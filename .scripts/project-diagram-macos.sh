...
DOT_NAME="project-diagram.dot"
IMG_NAME="project-diagram.svg"

mkdir -p "$DOC_DIR"

cargo modules dependencies --lib --no-externs --no-fns --no-sysroot --no-traits --no-types --no-uses > "$DOC_DIR/$DOT_NAME"
